...
static constexpr auto qt_meta_stringdata_ZN15SingletonClientE = QtMocHelpers::stringData(
    "SingletonClient",
    "message_from_server",
    "",
    "msg",
...
Q_CONSTINIT static const uint qt_meta_data_ZN15SingletonClientE[] = {
...
Q_CONSTINIT const QMetaObject SingletonClient::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15SingletonClientE.offsetsAndSizes,
    qt_meta_data_ZN15SingletonClientE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15SingletonClientE_t,
        // Q_OBJECT / Q_GADGET
...
void SingletonClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (SingletonClient::*)(QString );
            if (_q_method_type _q_method = &SingletonClient::message_from_server; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *SingletonClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15SingletonClientE.stringdata0))
